...
def index():
    # Bağlantı
    connection = pypyodbc.connect('DRIVER={SQL Server};SERVER=DESKTOP-UU1HEIE\SQLEXPRESS;DATABASE=Trafik;UID=sa;PWD=1234')
    ...
    return render_template('haberler.html', data=df.to_dict(orient='records'))
